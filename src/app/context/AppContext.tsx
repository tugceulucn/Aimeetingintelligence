...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'detail.noSpeakersDetected': 'No speakers detected',
    'detail.noHighlightsAvailable': 'No highlights available.',
    'detail.confidence': 'Confidence',
    'detail.unassigned': 'Unassigned',
    'detail.noDecisionsRecorded': 'No decisions recorded.',
    'detail.noActionsRecorded': 'No actions recorded.',
    'detail.participationWarning': 'Participation could be more balanced',
    'detail.onlyDecisionsMade': 'Only {count} decisions made',
  },
  ...
  tr: {
    ...
    'detail.loading': 'Toplantı yükleniyor...',
    'detail.minutes': 'dakika',
    'detail.participants': 'katılımcı',
    'detail.noSpeakersDetected': 'Konuşmacı tespit edilemedi',
    'detail.noHighlightsAvailable': 'Öne Çıkan madde yok.',
    'detail.confidence': 'Güven',
    'detail.unassigned': 'Atanmamış',
    'detail.noDecisionsRecorded': 'Herhangi bir karar kaydedilmedi.',
    'detail.noActionsRecorded': 'Herhangi bir eylem maddesi kaydedilmedi.',
    'detail.participationWarning': 'Katılım daha dengeli olabilir',
    'detail.onlyDecisionsMade': 'Yalnızca {count} karar alındı',
  },
};
